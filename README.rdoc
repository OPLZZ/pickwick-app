...
You need to get token from api.damepraci.cz

`PICKWICK_TOKEN=xxxxxxx rails s`
...
Need to create simulator device
`android create avd --name pickwick_test --target 1`